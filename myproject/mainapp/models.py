...
class Product(models.Model):
    ...
    img_1 = models.ImageField(upload_to='products', null=True, default='/', verbose_name='Фотография')
    img_2 = models.ImageField(upload_to='products', null=True, default='/', verbose_name='Фотография только перед')
    img_3 = models.ImageField(upload_to='products', null=True, default='/', verbose_name='Фотография только зад')
